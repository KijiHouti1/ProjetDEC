        ...
        try:
            ...
            # -----Logique des appuis de touches
                ...
                for i in range(0,5):                    #ici on dessine les touches de clavier et on controle la couleur
                    ...
                    posy += 43 #43 pixels mais en hauteur
...
#pour les id
couleurs = {0x00:red, 0x01:lightred,0x02:persianred,
            0x03:hotpink,0x04:bloodorange,
            0x05:orange,0x06:ocre,0x07:jaune,0x08:lightgreen,
            0x09:green,0x0A:aquamarine,0x0B:turquoise,0x0C:lezard,
            0x0D:paleblue,0x0E:blue,0x0F:marin,0x10:lila,0x11:violet,
            0x12:mauve,0x13:black}
